...
public class home : MonoBehaviour
{
    ...
    private Vector3 objectAInitialPosition;
    ...
    void Start()
    {
        ...
        if (objectA != null)
        {
            objectAInitialPosition = objectA.position;
        }
    ...
    private IEnumerator HomeSequence()
    {
        ...
        {
            Vector3 startPos = objectA.position;
            Vector3 targetPos = new Vector3(objectA.position.x, objectAInitialPosition.y, objectA.position.z);
            float elapsed = 0f;
